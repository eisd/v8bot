	...
	var error = false, sandbox = {}, output = (function() {
		try {
			...
			sandbox = {
				console: {
					output:[],
					log:function(){ Array.prototype.push.apply(sandbox.console.output, Array.prototype.slice.call(arguments, 0)) }
				},
				print: function(){ Array.prototype.push.apply(sandbox.console.output, Array.prototype.slice.call(arguments, 0)) }
			};
